...
public class LogUIConstant {
	...
	public static final String SELECT_SEVERITY = "Select Severity";
	public static final String SELECT_START_DATE = "Select Start DateTime";
	public static final String SELECT_END_DATE = "Select End DateTime";
	public static final String SUBMIT = "Submit";
	public static final String SELECT_FILTER_CRITERIA = "Filter Criteria:";
